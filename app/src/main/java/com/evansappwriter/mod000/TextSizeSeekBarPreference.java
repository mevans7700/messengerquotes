...
public class TextSizeSeekBarPreference extends Preference implements
		OnSeekBarChangeListener {
	
	public static int maximum    = 30;
	...
	protected View onCreateView(ViewGroup parent) {
		...
		LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(150,
